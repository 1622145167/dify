const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Weidiguo account',
    langGeniusAccountTip: 'Your Weidiguo account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Weidiguo to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Weidiguo allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Weidiguo\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Weidiguo {{version}} is now available.',
    latestAvailable: 'Weidiguo {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
